...
: ${AMENT_CURRENT_PREFIX:="/home/hung/ws_offboard_control/src/install/px4_avoidance"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/px4_avoidance/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/px4_avoidance/environment/path.sh"
